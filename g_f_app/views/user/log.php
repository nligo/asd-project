                ...
                <div class="col-sm-8">
                    <form action="<?php echo $this->config->item('base_url');?>/Login/loginIn" method="post" name="form1" id="form1">
                        ...
                        <select name="userType" id="userType" class="form-control">
                            <option value="3" selected="selected">请选择角色</option>
                            <option value="1">商家登录</option>
                            <option value="2">接手登录</option>
            			</select>
                        </div>
                        <div class="form-group">
                        <a href="<?php echo $this->config->item('base_url').'/Reg/index';?>" style="color:#000">立即注册</a>
                        </div>
...
function checkButton(){	
	...
	var userType = $('#userType').val();
 	if(userType == 3)
	{
		warning('<strong>错误：&nbsp;&nbsp;<font color="#993300">请选择您的登录角色</font></strong>');return false;
	}
