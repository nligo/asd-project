                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <div class="info info1 center-block text-center">
                                ...
                                <h3 class="text-center">我的总发布数量</h3>
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="info info2 center-block text-center">
                                <?php echo !empty($countend) ? $countend : 0;?><span>个</span>
                                <h3 class="text-center">我任务完成数量</h3>
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="info info3 center-block text-center">
                                <?php echo !empty($countmoney) ? $countmoney['countmoney'] : 0;?><span>个</span>
                                <h3 class="text-center">我总付出佣金</h3>
                            </div>
                        </div>
